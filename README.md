...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-12 17:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c208b0d0-d05e-4eac-a706-b9664dfae49a.git
$ cd c208b0d0-d05e-4eac-a706-b9664dfae49a
```
